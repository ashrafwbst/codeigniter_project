...
class Pm extends CI_Controller {
    ...
    public function index() {
        ...
        $num_link = 10;
        $base_url = $this->Cms_model->base_link(). '/admin/pm/';
        // Pageination config
    ...
    public function viewMSG() {
        ...
        if($this->uri->segment(4) && is_numeric($this->uri->segment(4))){
            //Get users from database   
            $pm = $this->Cms_auth_model->get_pm($this->uri->segment(4));
            if($pm !== FALSE){
    ...
    public function newMSG() {
        ...
        if($this->uri->segment(4)){
            $this->template->setSub('main_pm', $this->Cms_auth_model->get_pm($this->uri->segment(4)));
        }
        //Load the view
    ...
    public function setRead() {
        ...
        //Load the form helper
        if($this->uri->segment(4) && is_numeric($this->uri->segment(4))){
            $this->Cms_auth_model->set_as_read_pm($this->uri->segment(4));            
        }
        redirect($this->cms_referrer->getIndex(), 'refresh');
    }
    ...
    public function setUnRead() {
        ...
        //Load the form helper
        if($this->uri->segment(4) && is_numeric($this->uri->segment(4))){
            $this->Cms_auth_model->set_as_unread_pm($this->uri->segment(4));            
        }
        redirect($this->cms_referrer->getIndex(), 'refresh');
    }
    ...
    public function delete() {
        ...
        admin_helper::is_allowchk('delete');
        if($this->uri->segment(4) && is_numeric($this->uri->segment(4))){
            $this->Cms_auth_model->delete_pm($this->uri->segment(4));
            $this->db->cache_delete_all();
            $this->session->set_flashdata('error_message','<div class="alert alert-success" role="alert">'.$this->lang->line('success_message_alert').'</div>');
        }
        redirect($this->cms_referrer->getIndex(), 'refresh');
