...
class MY_Config Extends MX_Config {
	...
	{       $CI =& get_instance();
                ...
                $cmsconfig = $CI->Cms_model->load_config();
                if($static && $cmsconfig->assets_static_active && $cmsconfig->assets_static_domain){
                    $base_url = rtrim($cmsconfig->assets_static_domain, '/').'/';
                }else{
