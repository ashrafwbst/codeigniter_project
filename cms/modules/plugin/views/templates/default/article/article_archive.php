    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="panel panel-primary panel-primary-custom">
                <div class="panel-heading"><b><i class="glyphicon glyphicon-edit"></i> <?php echo $this->Cms_model->getLabelLang('article_category_menu').': '.$category_name ?></b></div>
                ...
                <?php /*?><div class="blog-text-footer">
        ...
        <?php /*?><div class="col-sm-3 sidebar-custom-dm">
