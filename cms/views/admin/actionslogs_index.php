		...
		<div class="card">
			<div class="card-body">
				<div class="pull-right">
					<form action="<?php echo $this->Cms_model->base_link(). '/admin/actionslogs/'; ?>" method="get">
				...
				<?php echo  form_open($this->Cms_model->base_link(). '/admin/actionslogs/deleteindex'); ?>
					...
					<table class="table table-bordered table-hover table-striped contact_forms_tbl">
						<thead>
							<tr>
								...
								<th width="15%"><?php echo $this->lang->line('user_email'); ?></th>
								<th width="30%"><?php echo $this->lang->line('ip_address'); ?></th>
								<th width="20%"><?php echo $this->lang->line('bf_note'); ?></th>
						...
						<tbody>
							...
							<?php } else { ?>
								...
								foreach ($actions_logs as $u) {
									...
									echo '<td>'.$u['actions_logs_id'].'</td>';
									echo '<td><b>' . $u['email_login'] . '</b></td>';
