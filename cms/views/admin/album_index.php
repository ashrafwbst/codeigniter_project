...
<div class="row">
	...
	<div class="col-lg-12 col-md-12">
		<div class="h2 sub-header" style="margin-bottom: 15px;">
			All Albums <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/addAlbum" class="btn btn-success btn-sm"><span class="glyphicon glyphicon-plus"></span> Add Album</a>
		</div>
		<div class="card">
			<div class="card-body">
				 <?php 
						...
						<tbody>
							...
							<?php if(!empty($allAlbums))
							{
								...
								<tr>
									...
									<!-- <td><img height="150" width="150" src="<?php //echo base_url()."photo/album/".$value['image']; ?>">
									</td> -->
								 <td><a href="<?php echo base_url('admin/album/subimageIndex/').$value['id']; ?>">View Images</a></td> 
									<td><?php echo ($value['status'] == 1) ? 'Active' : 'InActive'; ?></td>
									<td><?php echo $value['add_date']; ?></td>

									<td><a href="<?php echo base_url("admin/album/update/").$value['id'] ; ?>" class="btn btn-info btn-sm" role="button"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; 
										<a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(<?php echo $value['heading']; ?>)" href="<?php echo base_url()."admin/album/delete/".$value['id'];  ?>"><i class="fa fa-trash-o"></i></a>
									</td>
