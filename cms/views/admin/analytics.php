        ...
        <div class="row">
            <div class="col-md-12">
                <?php if($settings->ga_client_id != NULL && $settings->ga_view_id != NULL){ ?>
                    ...
                    <?php
                    $att = 'id="last_days" class="form-control" onchange="this.options[this.selectedIndex].value && (window.location = \''.$this->Cms_model->base_link().'/admin/analytics/\'+this.options[this.selectedIndex].value);" onblur="this.options[this.selectedIndex].value && (window.location = \''.$this->Cms_model->base_link().'/admin/analytics/\'+this.options[this.selectedIndex].value);"';
                    $data = array();
