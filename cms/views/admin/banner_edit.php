		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				...
				<div class="h2 sub-header">
					<?php echo $this->lang->line('banner_edit') ?> <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/banner/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('banner_new') ?></a>
				</div>

				<?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/banner/update/'.$this->uri->segment(4)); ?>
				...
				<div class="control-group">
					...
					<label class="control-label" for="name">
						<?php echo $this->lang->line('banner_name'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="width">
						<?php echo $this->lang->line('banner_width'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="height">
						<?php echo $this->lang->line('banner_height'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="link">
						<?php echo $this->lang->line('banner_link'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="start_date">
						<?php echo $this->lang->line('startdate_field'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="end_date">
						<?php echo $this->lang->line('enddate_field'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="form-control-static" for="nofollow">
						...
						?>
						<?php echo $this->lang->line('banner_nofollow'); ?>
					</label>
				...
				<div class="control-group-fluid">
					...
					<div class="controls">
						...
						<div><img class="img-thumbnail img-responsive" src="<?php
                              ...
                              ?>" <?php if ($banner->img_path == "" || $banner->img_path == NULL) { echo "style='display:none;'"; } ?> width="
							<?php echo ($banner->width) ? $banner->width : '50%'; ?>"></div>

						<?php if ($banner->img_path != "" && $banner->img_path != NULL) { ?><label for="del_file"><input type="checkbox" name="del_file" id="del_file" value="<?php echo $banner->img_path?>"> <span class="remark">Delete File</span></label>
						<?php } ?>
				...
				<div class="form-actions">
					...
					<a class="btn btn-lg" href="<?php echo $this->cms_referrer->getIndex(); ?>">
