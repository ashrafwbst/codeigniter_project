    ...
    <div class="col-lg-12">
        ...
        <ol class="breadcrumb">
            ...
            <li class="active">
                ...
                <i><span class="fa fa-stats"></span></i> <?php echo $this->lang->line('banner_header') ?>
...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><a role="button" href="<?php echo ($this->uri->segment(5))?$this->cms_referrer->getIndex('view'):$this->cms_referrer->getIndex()?>" class="btn btn-default btn-sm"><i class="fa fa-arrow-left"></i> <?php echo  $this->lang->line('btn_back') ?></a></div>
                        ...
                        if ($bannerstat !== FALSE) {
                            ...
                            foreach ($bannerstat as $u) {
                                ...
                                if(!in_array($u['bannerdate'], $bannerdate_arr)){
                                    ...
                                    $count_d = $this->Cms_model->countData('banner_statistic', $search_arr_d); ?>
                    ...
                    <?php }else{ ?>
                        ...
                        <?php if ($year !== FALSE) { ?>
                            ...
                            <?php foreach ($year as $u) {
                                ...
                                $month = $this->Cms_model->getValueArray("MONTHNAME(timestamp_create) AS banner_month_name, MONTH(timestamp_create) AS banner_month", 'banner_statistic', $search_arr_y, '', 0, 'banner_month', 'DESC'); /* Can't group with sql only_full_group_by sql mode */
                                ...
                                if ($month !== FALSE) { 
                                    ...
                                    foreach ($month as $m) {
                                        ...
                                        if(!in_array($m['banner_month'], $bannermonth_arr)){
                                            ...
                                            $count_m = $this->Cms_model->countData('banner_statistic', $search_arr_m); ?>

                                            <li><a href="<?php echo $this->Cms_model->base_link().'/admin/banner/view/' . $this->uri->segment(4) . '/' . $u['banner_year'] . '-' . str_pad($m['banner_month'], 2, '0', STR_PAD_LEFT) ; ?>"><?php echo $u['banner_year'].' '.$m['banner_month_name'] ?> <span class="pull-right badge bg-red"><?php echo $count_m ?></span></a></li>
