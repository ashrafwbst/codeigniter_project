...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="h2 sub-header">
			<?php echo  $this->lang->line('category_new') ?> <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/addproductcategory" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('category_new') ?></a>
		</div>
		<?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/product/updatecategory/'.$this->uri->segment(4)); ?>
			...
			<div class="card-body">
				...
				<div class="control-group">
					<label class="control-label" for="category_image">
						<?php echo $this->lang->line('category_image'); ?>
					</label>
					<div class="controls">
				...
				<div class="form-actions">
					...
					?>
					<a class="btn btn-lg btn-danger" href="<?php echo $this->Cms_model->base_link(). '/admin/product/categories'; ?>">
