    ...
    <div class="col-md-6">
        <div class="info-box">
            ...
            <div class="info-box-content">
                <span class="info-box-text">(<?php echo $this->Cms_admin_model->getSoftwareInfo('n') ?>)</span>
                <span class="info-box-number"><?php echo $this->Cms_admin_model->getServerIp() ?></span>
            </div>
            <!-- /.info-box-content -->
        </div>
        <!-- /.info-box -->
    ...
    <div class="col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $this->Cms_admin_model->memUsage() ?> / <?php echo $this->Cms_admin_model->getMemLimit() ?></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
    ...
    <div class="col-md-3">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number"><?php echo $this->Cms_admin_model->usageSpace() ?></span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body" style="word-wrap:break-word;">
                <b><?php echo $this->lang->line('serverstatus_os') ?>:</b> <?php echo $this->Cms_admin_model->getSoftwareInfo('s') ?> <?php echo $this->Cms_admin_model->getSoftwareInfo('r') ?> <?php echo $this->Cms_admin_model->getSoftwareInfo('v') ?> <?php echo $this->Cms_admin_model->getSoftwareInfo('m') ?><br>
                ...
                <b><?php echo $this->lang->line('serverstatus_php_disabled') ?>:</b> <?php echo $this->Cms_admin_model->getDisabledFunctions() ?>
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <?php echo form_open($this->Cms_model->base_link().'/admin/filemanager/templateCopy'); ?>
        <div class="control-group">	
            ...
            <div class="controls">
                ...
                <span class="remark"><em><a href="<?php echo $this->Cms_model->base_link(); ?>/admin/settings" title="<?php echo '(' . $this->lang->line('settings_theme') . ') ' . $this->lang->line('settings_header') . ' ' .$this->lang->line('banner_link'); ?>!"><b><?php echo '(' . $this->lang->line('settings_theme') . ') ' . $this->lang->line('settings_header') . ' ' .$this->lang->line('banner_link'); ?>!</b></a></em></span>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <?php echo form_close(); ?>
    </div>
