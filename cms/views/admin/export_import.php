<?php if($this->uri->segment(4) && $this->db->table_exists($this->uri->segment(4))) { 
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="h2 sub-header"><?php echo $this->lang->line('db_table_name') ?>: <?php echo $this->uri->segment(4) ?> <a role="button" href="<?php echo $this->cms_referrer->getIndex('export')?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo $this->lang->line('btn_back') ?></a></div>
            <?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/export/importdb/'.$this->uri->segment(4)) ?>
            <div class="box box-danger">
                ...
                <div class="box-footer">
                    <?php
                        ...
                        <a role="button" href="<?php echo $this->cms_referrer->getIndex('export')?>" class="btn btn-default"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo $this->lang->line('btn_cancel') ?></a>
                </div>
            </div>
            <?php echo form_close(); ?>
            <!-- /.box -->       
