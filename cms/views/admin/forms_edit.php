	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				...
				<?php echo  $this->lang->line('forms_edit') ?>
...
<div class="row">
	...
	<div class="col-lg-12 col-md-12">
		...
		<div class="h2 sub-header">
			<?php echo  $this->lang->line('forms_edit') ?> <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/forms/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('forms_addnew') ?></a>
		</div>
		<div class="card">
			<div class="card-body">
				<?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/forms/edited/'.$this->uri->segment(4)); ?>
				...
				<div class="control-group">
					...
					<label class="control-label" for="form_name">
						<?php echo $this->lang->line('forms_name'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="form_enctype">
				...
				<div class="control-group">
					...
					<label class="control-label" for="form_method">
				...
				<div class="control-group">
					...
					<label class="control-label" for="success_txt">
						<?php echo $this->lang->line('forms_success_txt'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="captchaerror_txt">
						<?php echo $this->lang->line('forms_captchaerror_txt'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="error_txt">
						<?php echo $this->lang->line('forms_error_txt'); ?>
					</label>
				...
				<div class="row">
					...
					<div class="panel-body" id="chk-sendmail" <?php if(!$form_rs->sendmail){ ?> style="display: none;"
						<?php } ?>>
						...
						<div class="control-group">
							...
							<label class="control-label" for="email">
								<?php echo $this->lang->line('forms_email'); ?>
							</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="subject">
								<?php echo $this->lang->line('forms_subject'); ?>
							</label>
				...
				<div class="row">
					...
					<div class="panel-body" id="chk-visitor" <?php if(!$form_rs->send_to_visitor){ ?> style="display: none;"
						<?php } ?>>
						...
						<div class="control-group">
							...
							<label class="control-label" for="email_field_id">
								<?php echo $this->lang->line('forms_email_field_name'); ?>
							</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="visitor_subject">
								<?php echo $this->lang->line('forms_visitor_subject'); ?>
							</label>
						...
						<label class="control-label" for="visitor_body">
							<?php echo $this->lang->line('forms_visitor_body'); ?>
						</label>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12" style="padding: 0 25px;">
						<div class="h2 sub-header">
							<?php echo  $this->lang->line('field_editheader') ?>
						</div>
									...
									<div class="panel-body row">
										...
										<div class="col-md-12">
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_type1">
													<?php echo $this->lang->line('field_type'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_name1">
													<?php echo $this->lang->line('field_name'); ?>*</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_id1">
													<?php echo $this->lang->line('field_id'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_class1">
													<?php echo $this->lang->line('field_class'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_placeholder1">
													<?php echo $this->lang->line('field_placeholder'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_value1">
													<?php echo $this->lang->line('field_value'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_label1">
													<?php echo $this->lang->line('field_label'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="sel_option_val1">
													<?php echo $this->lang->line('sel_option_val'); ?>
												</label>
											...
											<div class="control-group">
												...
												<label class="control-label" for="field_required1">
													<?php echo $this->lang->line('field_require'); ?>
												</label>
											...
											<div class="control-group text-right">
												...
												<a class="btn btn-danger" role="button" onclick="return confirm('<?php echo $this->lang->line('forms_delete_msg')?>')" href="<?php echo $this->Cms_model->base_link().'/admin/forms/deleteField/'.$form_rs->form_main_id.'/'.$field_val['form_field_id']?>">
								...
								<div class="panel-body row">
									<div class="col-md-12">
										...
										<div class="control-group">
											...
											<label class="control-label" for="field_class">
												<?php echo $this->lang->line('field_class'); ?>
											</label>
										...
										<div class="control-group">
											...
											<label class="control-label" for="field_placeholder">
												<?php echo $this->lang->line('field_placeholder'); ?>
											</label>
										...
										<div class="control-group">
											...
											<label class="control-label" for="field_value">
												<?php echo $this->lang->line('field_value'); ?>
											</label>
										...
										<div class="control-group">
											...
											<label class="control-label" for="sel_option_val">
												<?php echo $this->lang->line('sel_option_val'); ?>
											</label>
						...
						<div class="text-right">
							<?php echo $this->lang->line('field_addtxtinfo')?>
						</div>
					</div>
				</div>
				<div class="form-actions">
					...
					<a class="btn btn-danger m-r-10" href="<?php echo $this->cms_referrer->getIndex(); ?>">
