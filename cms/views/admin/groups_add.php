...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('user_group_new') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/groups/add" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span></span> <?php echo $this->lang->line('user_group_new') ?></a></div>
		<div class="card">
			<div class="card-body">
        <?php echo form_open($this->Cms_model->base_link(). '/admin/groups/insert'); ?>
