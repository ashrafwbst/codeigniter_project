...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('user_group_new') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/groups/add" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo $this->lang->line('user_group_new') ?></a></div>
		<div class="card">
			<div class="card-body">
				<?php echo form_open($this->Cms_model->base_link(). '/admin/groups/update/' . $group->user_groups_id); ?>
						...
						<div class="col-md-6">
							...
							<div class="box box-body no-padding">
								...
								<?php foreach($b_perms as $value){ 
									...
									if($this->Cms_auth_model->is_group_allowed($value['user_perms_id'], 'backend', $group->user_groups_id) !== FALSE){
						...
						<div class="col-md-6">
							...
							<div class="box box-body no-padding">
								...
								<?php foreach($f_perms as $value){ 
									...
									if($this->Cms_auth_model->is_group_allowed($value['user_perms_id'], 'frontend', $group->user_groups_id) !== FALSE){
