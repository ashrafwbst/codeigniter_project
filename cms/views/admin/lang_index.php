...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('lang_header') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/lang/new" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('lang_addnew') ?></a></div>
        <?php echo form_open($this->Cms_model->base_link(). '/admin/lang/indexSave'); ?>
                ...
                <tbody class="ui-sortable">
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($lang as $u) {
                            ...
                            echo '<td class="text-center"><a href="'.$this->Cms_model->base_link().'/admin/lang/edit/' . $u['lang_iso_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a> &nbsp;&nbsp;&nbsp; <a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(\''.$this->lang->line('lang_delete_message').'\')" href="'.$this->Cms_model->base_link().'/admin/lang/delete/'.$u['lang_iso_id'].'"><i class="glyphicon glyphicon-remove"></i> '.$this->lang->line('btn_delete').'</a></td>';
                            echo '</tr>';
                        }
                    }    ?>
                </tbody>
