...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h4 sub-header"><b><?php echo  $this->lang->line('btn_view') ?>:</b> <?php echo $url_link; ?> <a role="button" href="<?php echo $this->cms_referrer->getIndex()?>" class="btn btn-default btn-sm"><i class="glyphicon glyphicon-arrow-left"></i> <?php echo  $this->lang->line('btn_back') ?></a></div>
        <form action="<?php echo $this->Cms_model->base_link(). '/admin/linkstats/view/'.$this->uri->segment(4).'/'.$this->uri->segment(5).'/'; ?>" method="get">
        ...
        <br><br>
        <?php echo  form_open($this->Cms_model->base_link(). '/admin/linkstats/deleteviewid'); ?>
