<?php $row = $this->Cms_model->load_config(); ?>
<div class="login-register-bg">
<div class="container">
    <div class="row">
        <div class="col-md-3 hidden-sm hidden-xs"></div>
        <div class="col-md-6 col-sm-12 col-xs-12">
            <?php /*?><center><span style="font-size:36px;"><a href="<?php echo $this->Cms_model->base_link() ?>" target="_blank"><?php echo $this->Headfoot_html->getLogo(); ?></a></span></center><?php */?>
            <br><br>
            <div class="panel panel-primary">
                ...
                <div class="panel-body text-left">
                    ...
                    <?php echo form_open($this->Cms_model->base_link(). '/admin/login/check') ?>
                ...
                <div class="panel-footer text-center"><a href="<?php echo $this->Cms_model->base_link(); ?>/admin/user/forgot"><i class="fa fa-lock"></i> <?php echo $this->lang->line('login_forgetpwd'); ?></a></div>
            </div>
        </div>
        <div class="col-md-3 hidden-sm hidden-xs"></div>
    </div>
...
<script type="text/javascript">
            if ('serviceWorker' in navigator) {
               ...
               navigator.serviceWorker.register('<?php echo $this->Cms_model->base_link().'/admin/service_worker.js'; ?>')
                .then(function(reg) {
