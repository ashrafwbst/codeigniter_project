...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo  $this->lang->line('user_edit_header') ?>  <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/members/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('user_addnew') ?></a></div>

        <?php echo form_open_multipart($this->Cms_model->base_link().'/admin/members/edited/'.$this->uri->segment(4)); ?>
		<div class="card">
			<div class="card-body">
