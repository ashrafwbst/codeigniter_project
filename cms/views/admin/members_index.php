...
<div class="row">
    <div class="col-lg-12">
        <ol class="breadcrumb">
            <li class="active">
                <i><span class="fa fa-user"></span></i> <?php echo  $this->lang->line('user_member_txt') ?>
            </li>
        </ol>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('user_header') ?> <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/members/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('user_addnew') ?></a></div>        
        <div class="card">
			<div class="card-body">
				<div class="pull-right">
					<form action="<?php echo $this->Cms_model->base_link(). '/admin/members/'; ?>" method="get">
						...
						<tbody>
							...
							<?php } else { ?>
								...
								foreach ($users as $u) {
									...
									echo '</span></td>';
									echo '<td ><a href="'.$this->Cms_model->base_link().'/admin/members/view/' . $u['user_admin_id'] . '" class="btn btn-primary btn-sm" role="button"><i class="fa fa-eye"></i></a> &nbsp;&nbsp; <a href="'.$this->Cms_model->base_link().'/admin/members/edit/' . $u['user_admin_id'] . '" class="btn btn-info btn-sm" role="button"><i class="fa fa-pencil"></i></a> &nbsp;&nbsp; <a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(\''.$this->lang->line('user_delete_message').'\')" href="'.$this->Cms_model->base_link().'/admin/members/delete/'.$u['user_admin_id'].'"><i class="fa fa-trash-o"></i></a></td>';
									echo '</tr>';
								}
							}
							?>
