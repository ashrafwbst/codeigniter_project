...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo  $this->lang->line('pages_addnew') ?>  <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/pages/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('pages_addnew') ?></a></div>
		<div class="card">
			<div class="card-body">
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('page_name', $this->Cms_admin_model->getDraftArray('page_name') , FALSE)
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('page_title', $this->Cms_admin_model->getDraftArray('page_title'), FALSE)
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('page_keywords', $this->Cms_admin_model->getDraftArray('page_keywords'), FALSE)
        ...
        <div class="control-group">
            ...
            $data = array(
                ...
                'value' => set_value('page_desc', $this->Cms_admin_model->getDraftArray('page_desc'), FALSE)
        ...
        <div class="control-group">	
            ...
            <?php
                ...
                echo form_dropdown('lang_iso', $data, $this->Cms_admin_model->getDraftArray('lang_iso'), $att);
        ...
        <?php if($this->Cms_auth_model->is_group_allowed('pages cssjs additional', 'backend') !== FALSE){ ?>
            ...
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'value' => set_value('more_metatag', $this->Cms_admin_model->getDraftArray('more_metatag'), FALSE)
            ...
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'value' => set_value('custom_css', $this->Cms_admin_model->getDraftArray('custom_css'), FALSE)
            ...
            <div class="control-group">            
                ...
                $data = array(
                    ...
                    'value' => set_value('custom_js', $this->Cms_admin_model->getDraftArray('custom_js'), FALSE)
        ...
        <div class="control-group-fluid">
            ...
            <textarea name="content" id="content" class="form-control body-tinymce"><?php if($this->Cms_admin_model->getDraftArray('content')){ echo $this->Cms_admin_model->getDraftArray('content'); }else{ echo $starter_html; } ?></textarea>

        </div> <!-- /control-group-fluid --> <div class="clearfix"></div>
