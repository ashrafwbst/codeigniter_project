	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				...
				<?php echo  $this->lang->line('pages_addnew') ?>
	...
	<div class="col-lg-12 col-md-12">
		<div class="control-group">
			<div class="h2 sub-header">
				<?php echo  $this->lang->line('pages_addnew') ?> <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/pages/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('pages_addnew') ?></a>
			</div>
		</div>
		<div class="card">
			<div class="card-body">
				<?php echo form_open($this->Cms_model->base_link(). '/admin/pages/edited/'.$pages->pages_id); ?>
					...
					<div class="col-lg-12 col-md-12">
						<div class="control-group">
							...
							<label class="control-label" for="page_name">
								<?php echo $this->lang->line('pages_name'); ?>*</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="page_title">
								<?php echo $this->lang->line('pages_title'); ?>*</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="page_keywords">
								<?php echo $this->lang->line('pages_keywords'); ?>*</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="page_desc">
								<?php echo $this->lang->line('pages_desc'); ?>*</label>
				...
				<div class="row">
					...
					<div class="col-lg-12 col-md-12">
						...
						<div class="control-group">
							...
							<label class="control-label" for="more_metatag">
						...
						<div class="control-group">
							...
							<label class="control-label" for="custom_css">
								<?php echo $this->lang->line('pages_custom_css'); ?>
							</label>
						...
						<div class="control-group">
							...
							<label class="control-label" for="custom_js">
								<?php echo $this->lang->line('pages_custom_js'); ?>
							</label>
					...
					<div class="col-lg-12 col-md-12">
						<div class="control-group-fluid">
							<label class="control-label" for="content">
								<?php echo $this->lang->line('pages_content'); ?>
							</label>
							<iframe name="content" id="content" class="form-control body-tinymce"><?php echo  $pages->content ?></iframe>
						</div>
					</div>
				</div>
