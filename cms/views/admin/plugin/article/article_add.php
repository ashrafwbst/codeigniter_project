...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('article_new_header').' <a class="btn btn-default btn-sm" style="margin-bottom: 15px;" href="'.$this->cms_referrer->getIndex('article_art').'"><span class="glyphicon glyphicon-arrow-left"></span> '.$this->lang->line('btn_back').'</a>'; ?></div>
		<div class="card">
			<div class="card-body">
        <?php echo form_open_multipart($this->Cms_model->base_link().'/admin/plugin/article/addsave'); ?>     
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('title', $this->Cms_admin_model->getDraftArray('title'), FALSE)
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('keyword', $this->Cms_admin_model->getDraftArray('keyword'), FALSE)
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'value' => set_value('short_desc', $this->Cms_admin_model->getDraftArray('short_desc'), FALSE)
        ...
        <div class="control-group">
            ...
            echo form_dropdown('cat_id', $data, $this->Cms_admin_model->getDraftArray('cat_id'), $att);
        ...
        <div class="form-actions">
            ...
            <a class="btn btn-lg btn-danger" href="<?php echo $this->cms_referrer->getIndex('article_art'); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
