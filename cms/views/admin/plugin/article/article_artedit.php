...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('article_edit_header') . ' <a class="btn btn-default btn-sm" style="margin-bottom: 15px;" href="'.$this->cms_referrer->getIndex('article_art').'"><span class="glyphicon glyphicon-arrow-left"></span> '.$this->lang->line('btn_back').'</a>'; ?></div>
<div class="card">
			<div class="card-body">
        <?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/plugin/article/editArtSave/'.$this->uri->segment(5)); ?>
            ...
            <?php echo form_error('file_upload', '<div class="alert alert-danger text-center" role="alert"><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>', '</div>'); ?>									
                ...
                <div class="controls">
                    ...
                    <div class="main_pic_img"><img src="<?php
