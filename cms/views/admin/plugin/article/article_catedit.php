...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('category_edit_header') . ' <a class="btn btn-default btn-sm" style="margin-bottom: 15px;" href="'.$this->cms_referrer->getIndex('article_cat').'"><span class="glyphicon glyphicon-arrow-left"></span> '.$this->lang->line('btn_back').'</a>'; ?></div>
		<div class="card">
			<div class="card-body">
        <?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/plugin/article/editCatSave/'.$this->uri->segment(5)); ?>
			...
			<div class="form-actions">
				...
				<a class="btn btn-lg btn-danger" href="<?php echo $this->cms_referrer->getIndex('article_cat'); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
