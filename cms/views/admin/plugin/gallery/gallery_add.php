...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <div class="h2 sub-header"><?php echo $this->lang->line('gallery_new_header'); ?> <a class="btn btn-default btn-sm" style="margin-bottom: 15px;" href="<?php echo $this->cms_referrer->getIndex('gallery'); ?>"><span class="fa fa-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a></div>

        <?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/plugin/gallery/addSave'); ?>
		<div class="card">
			<div class="card-body">
				<div class="control-group">	
					...
					$data = array(
						...
						'value' => set_value('album_name', $this->Cms_admin_model->getDraftArray('album_name'), FALSE)
				...
				<div class="form-actions">
					...
					$data = array(
						...
						'class' => 'btn btn-lg btn-warning m-r-10',
					...
					<a class="btn btn-lg btn-danger" href="<?php echo $this->cms_referrer->getIndex('gallery'); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12"> <span class="remark" style="padding: 20px 0 0 10px;display: block;;"><?php echo $this->lang->line('gallery_remark'); ?></span></div>
				</div>
