	...
	<div class="col-lg-12">
		...
		<ol class="breadcrumb">
			...
			<li class="active">
				...
				<?php echo $this->lang->line('btn_edit').' '.$this->lang->line('gallery_new_header'); ?>
...
<div class="row">
	...
	<div class="col-lg-12 col-md-12">
		...
		<div class="h2 sub-header">
			<?php echo $this->lang->line('btn_edit').' '.$this->lang->line('gallery_new_header'); ?> <a class="btn btn-default btn-sm" style="margin-bottom: 15px;" href="<?php echo $this->cms_referrer->getIndex('gallery'); ?>"><span class="glyphicon glyphicon-arrow-left"></span> <?php echo $this->lang->line('btn_back'); ?></a>
		</div>
		<div class="card">
			<div class="card-body">
				<?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/plugin/gallery/editSave/'.$this->uri->segment(5)); ?>
				...
				<div class="control-group">
					...
					<label class="control-label" for="album_name">
						<?php echo $this->lang->line('gallery_albumname'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="keyword">
						<?php echo $this->lang->line('gallery_keyword'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="short_desc">
						<?php echo $this->lang->line('gallery_short_desc'); ?>*</label>
				...
				<div class="control-group activate_btn">
				...
				<div class="form-actions">
					...
					<a class="btn btn-lg" href="<?php echo $this->cms_referrer->getIndex('gallery'); ?>">
	...
	<div class="row">
		<div class="col-md-12">
			<div class="h2 sub-header">
					<?php echo $this->lang->line('gallery_picture') ?>
				</div>
		</div>
	</div>
		<!-- /.row -->
<div class="card">
		...
		<div class="row">
			...
			<div class="col-lg-12 col-md-12">
				...
				<div class="row">
					<div class="col-lg-6 col-md-6">
						...
						<div class="h4 sub-header">
							<?php echo  $this->lang->line('gallery_youtube_head') ?>
						</div>

						<?php echo  form_open($this->Cms_model->base_link(). '/admin/plugin/gallery/addYoutube/'.$this->uri->segment(5)) ?>
						...
						<div class="form-group has-feedback" style="position: relative;">
							...
							<div class="input-group">
								<label class="control-label"><?php echo  $this->lang->line('gallery_youtube_url') ?></label>
					...
					<div class="col-lg-12 col-md-6">
						...
						<?php echo  form_open_multipart($this->Cms_model->base_link(). '/admin/plugin/gallery/htmlUpload/'.$this->uri->segment(5)) ?>
				...
				<blockquote class="remark" style="margin-top: 15px;">
					<em>
						<?php echo  $this->lang->line('gallery_fileallow') ?>
					</em>
				</blockquote>
				<?php echo  form_open($this->Cms_model->base_link(). '/admin/plugin/gallery/uploadIndexSave'); ?>
						...
						<tbody class="ui-sortable">
							...
							<tr>
								...
								<td>
									...
									<?php if($file['arrange'] == 1){ ?> <i class="glyphicon glyphicon-book"></i>
									<?php } ?>
									...
									<div class="form-group has-feedback">
										...
										<div class="input-group">
											...
											<div class="input-group-addon">
												<b>
													<?php echo  $this->lang->line('gallery_caption') ?>
												</b>
											</div>
				...
				<div class="row">
					<div class="col-lg-12 col-md-12" style="padding-bottom: 15px;">
						<span class="warning"><i class="glyphicon glyphicon-book"></i> <?php echo  $this->lang->line('gallery_list_remark') ?></span>
					</div>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12">
						...
						<a class="tn btn-lg btn-danger m-r-10" href="<?php echo $this->cms_referrer->getIndex('gallery'); ?>">
							<?php echo $this->lang->line('btn_cancel'); ?>
						</a>
