...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('pm_new_msg') ?> <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/pm/newpm" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('pm_new_msg') ?></a></div>       
        <?php echo form_open($this->Cms_model->base_link(). '/admin/pm/insert'); ?>
        <?php if($this->uri->segment(4)){ ?>
            <div class="control-group">	
                <b><?php echo $this->lang->line('pm_to') ?>:</b> <?php echo $this->Cms_admin_model->getUser($main_pm->sender_id)->name; ?>
