...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('pm_send') ?> <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/pm/newpm" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('pm_new_msg') ?></a></div>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($msg as $u) {
                            ...
                            echo '<td class="text-center" style="vertical-align:middle;"><a href="'.$this->Cms_model->base_link(). '/admin/pm/view/'.$u['id'].'">' . $this->Cms_admin_model->getUser($u['receiver_id'])->name . '</a></td>';
                            echo '<td class="text-center" style="vertical-align:middle;"><a href="'.$this->Cms_model->base_link(). '/admin/pm/view/'.$u['id'].'">' . $u['title'] . '</a></td>';
                            echo '<td class="text-center" style="vertical-align:middle;"><a href="'.$this->Cms_model->base_link(). '/admin/pm/view/'.$u['id'].'">' . $u['date_sent'] . '</a></td>';
                            echo '</tr>';
                        }
                        ?>
                    <?php } ?>
