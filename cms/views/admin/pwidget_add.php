...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('pwidget_new_header') ?> <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/pwidget/addWidget" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('pwidget_new_header') ?></a></div>
        <?php echo form_open($this->Cms_model->base_link(). '/admin/pwidget/insert'); ?>
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('name', $this->Cms_admin_model->getDraftArray('name'), FALSE)
            );
            ...
            <div class="controls">
                ...
                if(!empty($getPlugin)){
                    foreach ($getPlugin as $value) {
                        $data[$value] = $this->Cms_model->getPluginConfig($value, 'plugin_name');
                    }
                }
                echo form_dropdown('plugin_filename', $data, $this->Cms_admin_model->getDraftArray('plugin_filename'), $att);
                ?>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-group">
                    ...
                    $data = array();
                    $data[''] = $this->lang->line('option_choose');
                    echo form_dropdown('sort_by', $data, $this->Cms_admin_model->getDraftArray('sort_by'), $att);
                    ?>
                    <div class="input-group-addon">
                        ...
                        $data['ASC'] = 'ASC';
                        $data['DESC'] = 'DESC';
                        echo form_dropdown('order_by', $data, $this->Cms_admin_model->getDraftArray('order_by'), $att);
                        ?>
                    </div>
                </div>
            </div> <!-- /controls -->				
        ...
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $data[50] = 50;
                $data[100] = 100;
                echo form_dropdown('data_limit', $data, $this->Cms_admin_model->getDraftArray('data_limit'), $att);
                ?>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <div class="control-group">
            ...
            $data = array(
                ...
                'maxlength' => '11',
                'value' => set_value('view_id', $this->Cms_admin_model->getDraftArray('view_id'), FALSE)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
        ...
        <div class="control-group">            
            ...
            $data = array(
                ...
                'value' => set_value('template_code', $this->Cms_admin_model->getDraftArray('template_code'), FALSE)
            );
