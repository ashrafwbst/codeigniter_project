...
<div class="row">
	<div class="col-lg-12">
		<ol class="breadcrumb">
			<li class="active">
				<i><span class="fa fa-cogs"></span></i>
...
<!-- /.row -->
<?php echo form_open_multipart($this->Cms_model->base_link().'/admin/settings/update'); ?>
...
<div class="card">
	<div class="card-body">
		...
		<div class="row">
			<div class="col-lg-12 col-md-12" style="padding: 0 5px;">
				<div class="control-group">
					...
					<label class="control-label" for="siteTitle">
						<?php echo $this->lang->line('settings_name'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="siteFooter">
						<?php echo $this->lang->line('settings_footer'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="siteKeyword">
						<?php echo $this->lang->line('settings_keyword'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="siteTheme">
						<?php echo $this->lang->line('settings_theme'); ?>
					</label>
					<div class="controls">
						<?php
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="siteLang">
						<?php echo $this->lang->line('settings_lang'); ?>
					</label>
					<div class="controls">
						<?php
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="pagecache_time">
						<?php echo $this->lang->line('settings_pagecache_time'); ?>
					</label>
					<div class="controls">
						<?php
				...
				<div class="control-group">
					<label class="control-label" for="additional_js">
						<?php echo $this->lang->line('settings_add_js'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group">
					<label class="control-label" for="additional_css">
						<?php echo $this->lang->line('additional_css'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
						...
						echo form_textarea( $data, $settings->additional_css );
						?>
						<span class="remark"><em><?php echo $this->lang->line('settings_add_css_remark'); ?></em></span>
					</div>
					<!-- /controls -->
				</div>
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="additional_metatag">
						<?php echo $this->lang->line('settings_add_meta'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="assets_static_domain">
						<?php echo $this->lang->line('settings_assets_static_domain'); ?>
					</label>
					<div class="controls">
						<div class="input-group">
							<div class="input-group-addon">
								<label for="assets_static_active">
									<?php
				...
				<div class="control-group">
					<label class="form-control-static" for="maintenance_active">
						...
						echo form_checkbox( $data );
						?>
						<?php echo $this->lang->line('settings_maintenance_active'); ?>
					</label>
				</div>
				<!-- /control-group -->
				<div class="control-group">
					<label class="form-control-static" for="html_optimize_disable">
						...
						echo form_checkbox( $data );
						?>
						<?php echo $this->lang->line('settings_html_optimize_disable'); ?>
					</label>
				</div>
				<!-- /control-group -->
				<div class="clearfix"></div>
				<div class="control-group">
					...
					<label class="control-label" for="file_upload">
						<?php echo $this->lang->line('settings_logo'); ?>
					</label>
					<div class="controls">
						...
						?>" id="logo_preloaded" <?php if($settings->site_logo == "" || $settings->site_logo == NULL){ echo "style='display:none;'"; } ?>>
						</div>
						<?php if($settings->site_logo != "" && $settings->site_logo != NULL){ ?><label for="del_file"><input type="checkbox" name="del_file" id="del_file" value="<?php echo $settings->site_logo ?>"> <span class="remark">Delete File</span></label>
						<?php } ?>
						<?php
						$data = array(
							'name' => 'file_upload',
				...
				<div class="control-group">
					...
					<label class="control-label" for="og_image">
						<?php echo $this->lang->line('settings_og_image'); ?>
					</label>
					<div class="controls">
						<div><img class="img-responsive img-thumbnail" src="<?php
						...
						?>" id="logo_preloaded" <?php if($settings->og_image == "" || $settings->og_image == NULL){ echo "style='display:none;'"; } ?>>
						</div>
						<?php if($settings->og_image != "" && $settings->og_image != NULL){ ?><label for="del_og_image"><input type="checkbox" name="del_og_image" id="del_og_image" value="<?php echo $settings->og_image ?>"> <span class="remark">Delete File</span></label>
						<?php } ?>
						<?php
						$data = array(
							'name' => 'og_image',
...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="h2 sub-header">
					<?php echo $this->lang->line('settings_member_header') ?>
				</div>
				<div class="row">
					<div class="control-group">
						<label class="form-control-static" for="member_confirm_enable">
							...
							echo form_checkbox( $data );
							?>
							<?php echo $this->lang->line('settings_member_confirm_active'); ?>
						</label>
					</div>
					<!-- /control-group -->
					<div class="control-group">
						<label class="form-control-static" for="member_close_regist">
							...
							echo form_checkbox( $data );
							?>
							<?php echo $this->lang->line('settings_member_close_regist'); ?>
						</label>
					</div>
					<!-- /control-group -->
					<br>
...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="h2 sub-header">
					<?php echo $this->lang->line('settings_sitemap_header') ?>
				</div>
				<a href="<?php echo $this->Cms_model->base_link().'/admin/settings/gensitemap' ?>" class="btn btn-success" style="margin-bottom: 15px;" title="<?php echo $this->lang->line('settings_sitemap_runnow') ?>">
					<?php echo $this->lang->line('settings_sitemap_runnow') ?>
				</a><br>
				<b>
					<?php echo $this->lang->line('settings_sitemap_lasttime') ?>: </b>
				<b>
					<?php if($sitemaptime !== FALSE){
...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="h2 sub-header">
					<?php echo $this->lang->line('settings_email_header') ?>
				</div>
			</div>
		</div>
		<div class="row">
			<div class="col-lg-12 col-md-12" style="padding: 0 5px;">
				<div class="control-group">
					<label class="control-label" for="siteEmail">
						<?php echo $this->lang->line('settings_email'); ?>
					</label>
					<div class="controls">
						<div class="input-group">
							<?php
							...
							<div class="input-group-btn">
								<a href="<?php echo $this->Cms_model->base_link().'/admin/settings/testsendmail' ?>" class="btn btn-primary" title="<?php echo $this->lang->line('settings_email_testbtn') ?>">
									<?php echo $this->lang->line('settings_email_testbtn') ?>
								</a>
							</div>
						</div>
					</div>
				...
				<!-- /control-group -->
				<div class="control-group">
					<label class="control-label" for="email_protocal">
						<?php echo $this->lang->line('settings_email_protocal'); ?>
					</label>
					<?php
				...
				<div class="control-group" id="smtp1" style="display:none;">
					<label class="control-label" for="smtp_host">
						<?php echo $this->lang->line('settings_smtp_host'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group" id="smtp2" style="display:none;">
					<label class="control-label" for="smtp_user">
						<?php echo $this->lang->line('settings_smtp_user'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group" id="smtp3" style="display:none;">
					<label class="control-label" for="smtp_pass">
						<?php echo $this->lang->line('settings_smtp_pass'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group" id="smtp4" style="display:none;">
					<label class="control-label" for="smtp_port">
						<?php echo $this->lang->line('settings_smtp_port'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group" id="sendmail" style="display:none;">
					<label class="control-label" for="sendmail_path">
						<?php echo $this->lang->line('settings_sendmail_path'); ?>
					</label>
					<div class="controls">
						<?php
						$data = array(
				...
				<div class="control-group" style="padding-top: 25px;">
					<label class="form-control-static" for="email_logs">
						...
						echo form_checkbox( $data );
						?>
						<?php echo $this->lang->line('settings_email_logs'); ?>
					</label>
				</div>
				<!-- /control-group -->
			</div>
...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="h2 sub-header">
					<?php echo $this->lang->line('settings_google_config') ?>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12" style="padding: 0 5px;">
					<div class="control-group">
						<label>Enable / Diable</label>
						<div class="clearfix"></div>
						<label class="form-control-static" for="googlecapt_active">
							...
							echo form_checkbox( $data );
							?>
							<?php echo $this->lang->line('settings_googlecapt_active'); ?>
						</label>
					</div>
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="googlecapt_sitekey">
							<?php echo $this->lang->line('settings_googlecapt_sitekey'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="googlecapt_secretkey">
							<?php echo $this->lang->line('settings_googlecapt_secretkey'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<div class="clearfix"></div>
					<div class="control-group">
						<label class="control-label" for="ga_client_id">
							<?php echo $this->lang->line('settings_ga_client_id'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="ga_view_id">
							<?php echo $this->lang->line('settings_ga_view_id'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<div class="control-group">
						...
						<label class="form-control-static" for="gsearch_active">
							...
							echo form_checkbox( $data );
							?>
							<?php echo $this->lang->line('settings_gsearch_active'); ?>
						</label>
					</div>
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="gsearch_cxid">
							<?php echo $this->lang->line('settings_gsearch_cxid'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<div class="clearfix"></div>
					<div class="control-group">
						<label class="control-label" for="gmaps_key">
							<?php echo $this->lang->line('settings_gmaps_key'); ?>
						</label>
						<div class="controls">
							<?php
							$data = array(
					...
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="gmaps_lat">
							<?php echo $this->lang->line('settings_gmaps_lat'); ?>
						</label>
						<div class="controls">
							<?php
					...
					<!-- /control-group -->
					<div class="control-group">
						<label class="control-label" for="gmaps_lng">
							<?php echo $this->lang->line('settings_gmaps_lng'); ?>
						</label>
						<div class="controls">
							<?php
...
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-lg-12 col-md-12">
				<div class="h2 sub-header">
					<?php echo $this->lang->line('settings_fbappid_header') ?>
				</div>
				<div class="row">
					<div class="col-lg-12 col-md-12" style="padding: 0 5px;">
						<div class="control-group">
							<label class="control-label" for="fbapp_id">
								<?php echo $this->lang->line('settings_fbapp_id'); ?>
							</label>
							<div class="controls">
								<?php
								$data = array(
						...
						<!-- /control-group -->
						<div class="control-group">
							<label class="control-label" for="facebook_page_id">
								<?php echo $this->lang->line('settings_facebook_page_id'); ?>
							</label>
							<div class="controls">
								<?php
								$data = array(
						...
						<div class="control-group">
							...
							<label class="form-control-static" for="fb_messenger">
								...
								echo form_checkbox( $data );
								?>
								<?php echo $this->lang->line('settings_fb_messenger'); ?>
							</label>
