...
<div class="row">
    ...
    <div class="col-lg-12 col-md-12">
        ...
        <form method="post" action="<?php echo base_url()."admin/updateSubAlbum/".$sub_album_id."/".$album_id;  ?>" enctype="multipart/form-data">
     
      <div class="clearfix"></div><br>

        <div class="control-group">   
            <input type="hidden" name="sub_album_id" value="<?php echo $sub_album_id; ?>">
            <label class="control-label" for="lang_iso">Album Image</label>
            <input type="file" name="album_image" class="form-control">
            <img src="<?php echo base_url()."photo/album/".$album['sub_image']; ?>" height="150" width="150">
        </div> 
         <div class="clearfix"></div><br>
