...
<div class="row">
	<div class="col-lg-12 col-md-12">
		<div class="h2 sub-header">
			<?php echo  $this->lang->line('user_addnew') ?> <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/users/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('user_addnew') ?></a>
		</div>
		<?php echo form_open_multipart($this->Cms_model->base_link(). '/admin/users/new/add'); ?>
			...
			<div class="card-body">
				...
				<div class="control-group">
					...
					<label class="control-label" for="password">
						<?php echo $this->lang->line('user_new_pass'); ?>*</label>
					<?php
					$data = array(
						'name' => 'password',
						'id' => 'password',
				...
				<div class="control-group">
					...
					<label class="control-label" for="con_password">
						<?php echo $this->lang->line('user_new_confirm'); ?>*</label>
					<?php
					$data = array(
						'name' => 'con_password',
						'id' => 'con_password',
