...
<div class="row">
	...
	<div class="col-lg-12 col-md-12">
		...
		<div class="h2 sub-header">
			<?php echo  $this->lang->line('user_edit_header') ?> <a role="button" href="<?php echo  $this->Cms_model->base_link() ?>/admin/users/new" class="btn btn-success btn-sm" style="margin-bottom: 15px;"><span class="fa fa-plus"></span> <?php echo  $this->lang->line('user_addnew') ?></a>
		</div>

		<?php echo form_open_multipart($this->Cms_model->base_link().'/admin/users/edited/'.$this->uri->segment(4)); ?>
			...
			<div class="card-body">
				<div class="control-group">
					...
					<label class="control-label" for="name">
						<?php echo $this->lang->line('user_new_name'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="email">
						<?php echo $this->lang->line('user_new_email'); ?>*</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="last_name">
						<?php echo $this->lang->line('user_last_name'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="group">
						<?php echo $this->lang->line('user_group_txt'); ?>*</label>
					...
					$user_group = $this->Cms_auth_model->get_groups_fromuser( $users->user_admin_id );
				...
				<div class="control-group">
					...
					<label class="control-label" for="user_type">
						<?php echo $this->lang->line('user_new_type'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="gender">
						<?php echo $this->lang->line('user_gender'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="password">
						<?php echo $this->lang->line('user_new_pass'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="con_password">
						<?php echo $this->lang->line('user_new_confirm'); ?>
					</label>
				...
				<div class="control-group">
					...
					<label class="control-label" for="cur_password">
						<?php echo $this->lang->line('user_cur_pass'); ?>*</label>
				...
				<div class="control-group">
					...
					<div class="controls">
						...
						<div><img class="img-thumbnail img-responsive" src="<?php
									  ...
									  ?>" <?php if ($users->picture == "" || $users->picture == NULL) { echo "style='display:none;'"; } ?> width="50%"></div>

						<?php if ($users->picture != "" && $users->picture != NULL) { ?><label for="del_file"><input type="checkbox" name="del_file" id="del_file" value="<?php echo $users->picture?>"> <span class="remark">Delete File</span></label>
						<?php } ?>
				...
				<div class="control-group activate_btn">
					...
					<label class="form-control-static" for="pm_sendmail">
						...
						?>
						<?php echo $this->lang->line('pm_header'); ?> (<i class="glyphicon glyphicon-envelope"></i>
						<?php echo $this->lang->line('login_email'); ?>)</label>
				...
				<div class="control-group activate_btn">
					...
					<label class="form-control-static" for="active">
						...
						?>
						<?php echo $this->lang->line('user_new_active'); ?>
					</label>
				...
				<div class="control-group-fluid">
					...
					<textarea name="address" id="address" class="form-control" style="height: 100px;"><?php echo $users->address; ?></textarea>
				</div>
				<!-- /control-group -->
