...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('widget_new_header') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/widget/addWidget" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('widget_new_header') ?></a></div>
        <?php echo form_open($this->Cms_model->base_link(). '/admin/widget/insert'); ?>
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('widget_name', $this->Cms_admin_model->getDraftArray('widget_name'), FALSE)
            );
        ...
        <div class="control-group">	
            ...
            $data = array(
                ...
                'class' => 'form-control',
                'maxlength' => '255',
                'value' => set_value('xml_url', $this->Cms_admin_model->getDraftArray('xml_url'), FALSE)
            );
            echo form_input($data);
            ?>
        </div> <!-- /control-group -->
        <div class="control-group">
            ...
            <div class="controls">
                ...
                $data[50] = 50;
                $data[100] = 100;
                echo form_dropdown('limit_view', $data, $this->Cms_admin_model->getDraftArray('limit_view'), $att);
                ?>
            </div> <!-- /controls -->				
        </div> <!-- /control-group -->
        <?php
        ...
        if(empty($widget->widget_content) || $widget->widget_content == NULL){
            $widget->widget_content = '<div class="row">
                                            <div class="col-md-3">
                                                <a href="{sub_url}" title="{title}"><img class="lazy img-responsive img-thumbnail" src="{photo}" alt="{title}"></a>
                                            </div>
                                            <div class="col-md-9">
        ...
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'widget_open',
                'class' => 'form-control',
                'value' => set_value('widget_open', ($this->Cms_admin_model->getDraftArray('widget_open')) ? $this->Cms_admin_model->getDraftArray('widget_open') : $widget->widget_open, FALSE)
            );
        ...
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'widget_content',
                'class' => 'form-control',
                'value' => set_value('widget_content', ($this->Cms_admin_model->getDraftArray('widget_content')) ? $this->Cms_admin_model->getDraftArray('widget_content') : $widget->widget_content, FALSE)
            );
            echo form_textarea($data);
            ?>			
        </div> <!-- /control-group -->
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'widget_seemore',
                'class' => 'form-control',
                'value' => set_value('widget_seemore', ($this->Cms_admin_model->getDraftArray('widget_seemore')) ? $this->Cms_admin_model->getDraftArray('widget_seemore') : $widget->widget_seemore, FALSE)
            );
            echo form_textarea($data);
            ?>			
        </div> <!-- /control-group -->
        <div class="control-group">            
            ...
            $data = array(
                ...
                'id' => 'widget_close',
                'class' => 'form-control',
                'value' => set_value('widget_close', ($this->Cms_admin_model->getDraftArray('widget_close')) ? $this->Cms_admin_model->getDraftArray('widget_close') : $widget->widget_close, FALSE)
            );
            echo form_textarea($data);
            ?>			
        </div> <!-- /control-group -->
        ...
        <div class="form-actions">
            ...
            ?> 
            <a class="btn btn-lg" href="<?php echo $this->cms_referrer->getIndex(); ?>"><?php echo $this->lang->line('btn_cancel'); ?></a>
        </div> <!-- /form-actions -->
        <?php echo form_close(); ?>
        <!-- /widget-content --> 
    </div>
