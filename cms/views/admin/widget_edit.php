...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo $this->lang->line('widget_edit_header') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link() ?>/admin/widget/addWidget" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo $this->lang->line('widget_new_header') ?></a></div>
        <?php echo form_open($this->Cms_model->base_link(). '/admin/widget/edited/'.$this->uri->segment(4)); ?>
