...
<div class="row">
    <div class="col-lg-12 col-md-12">
        <div class="h2 sub-header"><?php echo  $this->lang->line('widget_header') ?>  <a role="button" href="<?php echo $this->Cms_model->base_link()?>/admin/widget/addWidget" class="btn btn-default btn-sm"><span class="glyphicon glyphicon-plus"></span> <?php echo  $this->lang->line('widget_new_header') ?></a></div>
                ...
                <tbody>
                    ...
                    <?php } else { ?>
                        ...
                        foreach ($widget as $u) {
                            ...
                            echo '<td'.$inactive.' class="text-center"><a href="'.$this->Cms_model->base_link().'/admin/widget/editWidget/' . $u['widget_xml_id'] . '" class="btn btn-default btn-sm" role="button"><i class="glyphicon glyphicon-pencil"></i>  '.$this->lang->line('btn_edit').'</a> &nbsp;&nbsp;&nbsp; <a role="button" class="btn btn-danger btn-sm" role="button" onclick="return confirm(\''.$this->lang->line('delete_message').'\')" href="'.$this->Cms_model->base_link().'/admin/widget/delete/'.$u['widget_xml_id'].'"><i class="glyphicon glyphicon-remove"></i> '.$this->lang->line('btn_delete').'</a></td>';
                            echo '</tr>';
                        }
                    }    ?>
                </tbody>
