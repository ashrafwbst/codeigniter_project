    ...
    <div class="row">
        ...
        <div class="col-md-9">         
            <div class="panel panel-primary">
                <div class="panel-heading"><b><i class="glyphicon glyphicon-edit"></i> <?php echo $this->Cms_model->getLabelLang('edit_profile') ?></b></div>
                <div class="panel-body text-left">
                    <?php echo form_open_multipart($this->Cms_model->base_link().'/member/edit/save'); ?>
                    <div class="control-group">	
                        ...
                        <label class="control-label" for="name"><?php echo $this->Cms_model->getLabelLang('display_name'); ?>*</label>
                        <?php
                        $data = array(
                            'name' => 'name',
                            'id' => 'name',
                    ...
                    <div class="control-group">		
                        ...
                        <label class="control-label" for="email"><?php echo $this->Cms_model->getLabelLang('email_address'); ?>*</label>
                        <?php
                        $data = array(
                            'name' => 'email',
                            'id' => 'email',
                    ...
                    <div class="control-group">										
                        ...
                        ?> <?php echo $this->Cms_model->getLabelLang('pm_txt'); ?> (<i class="glyphicon glyphicon-envelope"></i> <?php echo $this->Cms_model->getLabelLang('email_address'); ?>)</label>	
                    </div> <!-- /control-group -->
                    <br>
                    <div class="panel panel-default">
                        <div class="panel-heading" onclick="ChkHideShow('newpassword');"><a href="#"><b><?php echo $this->Cms_model->getLabelLang('change_password'); ?></b></a></div>
                        <div class="panel-body" id="newpassword" style="display:none;">
                            <div class="control-group">		
                                ...
                                <label class="control-label" for="password"><?php echo $this->Cms_model->getLabelLang('new_password'); ?></label>
                                <?php
                                $data = array(
                                    'name' => 'password',
                                    'id' => 'password',
                            ...
                            <div class="control-group">	
                                ...
                                <label class="control-label" for="con_password"><?php echo $this->Cms_model->getLabelLang('confirm_password'); ?></label>
                                <?php
                                $data = array(
                                    'name' => 'con_password',
                                    'id' => 'con_password',
                    ...
                    <hr>
                    <div class="control-group">										
                        <label class="control-label" for="first_name"><?php echo $this->Cms_model->getLabelLang('first_name'); ?></label>
                        <?php
                        $data = array(
                            'name' => 'first_name',
                            'id' => 'first_name',
                    ...
                    <div class="control-group">										
                        <label class="control-label" for="last_name"><?php echo $this->Cms_model->getLabelLang('last_name'); ?></label>
                        <?php
                        $data = array(
                            'name' => 'last_name',
                            'id' => 'last_name',
                    ...
                    <div class="control-group">										
                        <label class="control-label" for="birthday"><?php echo $this->Cms_model->getLabelLang('birthday'); ?></label><br>
                        <?php
                    ...
                    <div class="control-group">										
                        <label class="control-label" for="gender"><?php echo $this->Cms_model->getLabelLang('gender'); ?></label>
                        <?php
                    ...
                    <div class="control-group">
                        <label class="control-label" for="address"><?php echo $this->Cms_model->getLabelLang('address'); ?></label>
                        <textarea name="address" id="address" class="form-control"><?php echo $users->address; ?></textarea>
                    </div> <!-- /control-group -->
                    <div class="control-group">										
                        <label class="control-label" for="phone"><?php echo $this->Cms_model->getLabelLang('phone'); ?></label>
                        <?php
                        $data = array(
                            'name' => 'phone',
                            'id' => 'phone',
                    ...
                    <br>
                    <div class="control-group">											
                        <label class="control-label" for="picture"><?php echo $this->Cms_model->getLabelLang('picture'); ?></label>
                        <div class="controls">
                            <div><img src="<?php
                                          if ($users->picture != "") {
                    ...
                    <div class="control-group">		
                        ...
                        <label class="control-label" for="cur_password"><?php echo $this->Cms_model->getLabelLang('login_password'); ?>*</label>
                        <?php
                        $data = array(
                            'name' => 'cur_password',
                            'id' => 'cur_password',
                    ...
                    <div class="form-actions">
                        ...
                        $data = array(
                            ...
                            'value' => $this->Cms_model->getLabelLang('save_btn'),
                        );
                        echo form_submit($data);
                        ?> 
                        <a class="btn btn-lg" href="<?php echo $this->cms_referrer->getIndex('member'); ?>"><?php echo $this->Cms_model->getLabelLang('cancel_btn'); ?></a>
                    </div> <!-- /form-actions -->
                    <?php echo form_close(); ?>
                    <!-- /widget-content --> 
                </div>
