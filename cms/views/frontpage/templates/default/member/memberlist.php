    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="panel panel-primary">
                <div class="panel-heading"><b><i class="glyphicon glyphicon-user"></i> <?php echo $this->Cms_model->getLabelLang('users_list_txt') ?></b></div>
                        ...
                        <table class="table table-bordered table-hover table-striped">
                            <thead>
                                <tr>
                                    ...
                                    <th width="20%" class="text-center" style="vertical-align:middle;"><?php echo $this->Cms_model->getLabelLang('picture'); ?></th>
                                    <th width="50%" class="text-center" style="vertical-align:middle;"><?php echo $this->Cms_model->getLabelLang('display_name'); ?></th>
                            ...
                            <tbody>
                                ...
                                <?php } else { ?>
                                    ...
                                    foreach ($users as $u) {
                                        ...
                                        echo '<td class="text-center" style="vertical-align:middle;"><a href="'.$this->Cms_model->base_link().'/member/viewuser/' . $u['user_admin_id'] . '" class="btn btn-info btn-sm" role="button"><i class="glyphicon glyphicon-eye-open"></i></a> &nbsp;&nbsp; <a href="'.$this->Cms_model->base_link().'/member/newpm/' . $u['user_admin_id'] . '" class="btn btn-primary btn-sm" role="button"><i class="glyphicon glyphicon-envelope"></i></a></td>';
                                        echo '</tr>';
                                    }
                                    ?>
                                <?php } ?>
