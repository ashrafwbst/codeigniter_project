    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="panel panel-primary">
                <div class="panel-heading"><b><i class="glyphicon glyphicon-send"></i> <?php echo $this->Cms_model->getLabelLang('pm_newmsg_txt') ?></b></div>
                <div class="panel-body">
                    ...
                    <br><br>
                    <?php echo form_open($this->Cms_model->base_link(). '/member/insertpm'); ?>
                    <?php if($this->uri->segment(3)){ ?>
                        <div class="control-group">	
                            <b><?php echo $this->Cms_model->getLabelLang('pm_to_txt') ?>:</b> <?php echo $this->Cms_admin_model->getUser($main_pm->sender_id)->name; ?>
                            <input type="hidden" name="to[]" id="to" value="<?php echo $main_pm->sender_id ?>">
                        </div> <!-- /control-group -->
                        <div class="control-group">
                            <b><?php echo $this->Cms_model->getLabelLang('pm_subject_txt') ?></b> Re: <?php echo $main_pm->title; ?>
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="control-group">	
                            ...
                            <label class="control-label" for="to"><?php echo $this->Cms_model->getLabelLang('pm_to_txt'); ?>*</label>
                            <?php
                        ...
                        <div class="control-group">	
                            ...
                            <label class="control-label" for="title"><?php echo $this->Cms_model->getLabelLang('pm_subject_txt'); ?>*</label>
                            <?php
                            $data = array(
                                'name' => 'title',
                                'id' => 'title',
                    ...
                    <div class="control-group">	
                        ...
                        <label class="control-label" for="message"><?php echo $this->Cms_model->getLabelLang('pm_msg_txt'); ?>*</label>
                        <?php
                            $data = array(
                                'name' => 'message',
                                'id' => 'message',
                    ...
                    <div class="form-actions">
                        ...
                        $data = array(
                            ...
                            'value' => $this->Cms_model->getLabelLang('pm_send_txt'),
                        );
                        echo form_submit($data);
                        ?> 
                        <a class="btn btn-default" href="<?php echo $this->cms_referrer->getIndex('member'); ?>"><?php echo $this->Cms_model->getLabelLang('btn_cancel'); ?></a>
                    </div> <!-- /form-actions -->
                    <?php echo form_close(); ?>
                    <!-- /widget-content -->
                </div>
