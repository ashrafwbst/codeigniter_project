...
<html lang="<?php echo $this->session->userdata('fronlang_iso') ?>" prefix="op: http://media.facebook.com/op#">
    ...
    <body>
        <article>
            ...
            <?php echo $this->Cms_model->remove_empty_htmltags(str_replace(array('<br>', '<p>&nbsp;</p>'), '', $article->content)) ?>
            <!-- End Body text for your article -->
            <hr>
            <footer>
                <!-- Credits for your article -->
                <aside><?php echo $this->Cms_model->remove_empty_htmltags(str_replace(array('%YEAR%', '%YEAR', '%Y%', '%y%'), date('Y'), $config->site_footer)) ?></aside>
                <!-- Copyright details for your article -->
                <small><?php echo $this->Cms_admin_model->cmsCopyright() ?></small>
            </footer>
        </article>
    </body>
