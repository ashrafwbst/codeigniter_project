...
function initialize() {
    ...
    + '<div class="map-title">' 
    + '<div class="brand" href="#"><img alt="" src="images/brand.png"><div class="brand-info"><div class="brand-name">Hwa Hak</div><div class="brand-text">Renovation Construction</div></div></div></div>' 
    + '<p class="map-address">'
